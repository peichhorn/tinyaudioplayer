...
public class PreviousHandlerTest {
	@Test
	public void whenInvoked_execute_shouldCallPlayerPrevious() throws Exception {
		// setup
		...
		// run
		new PreviousHandler().execute(event);
		// assert
		verify(player).previous();
	}
}
