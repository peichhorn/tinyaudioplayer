...
public class RemoveSelectedHandlerTest {
	@Test
	public void whenInvoked_execute_shouldCallPlayerRemoveSelected() throws Exception {
		// setup
		...
		// run
		new RemoveSelectedHandler().execute(event);
		// assert
