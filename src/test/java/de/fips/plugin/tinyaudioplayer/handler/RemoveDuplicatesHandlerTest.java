...
public class RemoveDuplicatesHandlerTest {
	@Test
	public void whenInvoked_execute_shouldCallPlayerRemoveDuplicates() throws Exception {
		// setup
		...
		// run
		new RemoveDuplicatesHandler().execute(event);
		// assert
		verify(player).removeDuplicates();
	}
}
